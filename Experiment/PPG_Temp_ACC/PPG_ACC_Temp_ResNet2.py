...
print(f"🚀 [Start] PPG+Temp+Acc System (Model: ResNet2, Fusion: ADDITION)", flush=True)
...
# ==========================================
# 3. 모델 아키텍처: ResNet2 + Addition Fusion
# ==========================================
...
class TriModalFusion(nn.Module):
    def __init__(self, num_users=16, d_model=256, num_heads=8):
        ...
        # --- [Change] Fusion: Addition (Lightweight) ---
        # Concat와 달리 차원이 커지지 않으므로 간단한 FC Layer 하나만 통과
...
if __name__ == "__main__":
    ...
    if len(gen_scores) > 0:
        ...
        print(f"\n======================================")
        print(f"🏆 최종 결과 리포트 (Model: ResNet2 + Addition)")
